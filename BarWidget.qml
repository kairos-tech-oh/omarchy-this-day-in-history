...
BarWidget {
  ...
  // its own AutoText Text elements (Ui/WidgetButton.qml, plugins/bar/Bar.qml),
  ...
  // into a sink this plugin doesn't own.
  //
  ...
  WidgetButton {
    ...
    bar: root.bar
    text: ""
    tooltipText: "This Day in History — click for today's fact"
